package net.sorenon.input.actionsets;

import net.sorenon.MCOpenXRClient;
import net.sorenon.input.XrInput;
import net.sorenon.input.actions.Action;
import net.sorenon.input.actions.BoolAction;
import net.sorenon.input.actions.Vec2fAction;
...
//    public XrAction middleClickAction;
    ...
    public boolean shouldSync() {
        return (MCOpenXRClient.INSTANCE.MCOpenXRGuiManager.isScreenOpen() | exit.currentState | pickup.currentState) && !XrInput.vanillaGameplayActionSet.inventory.currentState;
    }
    ...
    public void getDefaultBindings(HashMap<String, List<Pair<Action, String>>> map) {
        ...
        if (!MCOpenXRClient.OPEN_XR_STATE.instance.runtimeName.contains("Oculus")) {
        ...
        if (MCOpenXRClient.OPEN_XR_STATE.instance.handle.getCapabilities().XR_EXT_hp_mixed_reality_controller) {
        ...
        if (MCOpenXRClient.OPEN_XR_STATE.instance.handle.getCapabilities().XR_HTC_vive_cosmos_controller_interaction) {
