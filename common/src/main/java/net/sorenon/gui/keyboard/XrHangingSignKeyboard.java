...
public class XrHangingSignKeyboard extends XrAbstract2DKeyboard {
    ...
    private final XrHangingSignEditScreen _signEditScreen;

    private boolean _shift, _caps;

    private final boolean _isFront;

    public XrHangingSignKeyboard(XrHangingSignEditScreen signEditScreen, boolean isFront) {
