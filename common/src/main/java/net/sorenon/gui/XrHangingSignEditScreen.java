...
import net.sorenon.gui.keyboard.XrHangingSignKeyboard;

public class XrHangingSignEditScreen extends Screen {

    private final SignBlockEntity _sign;
    private final XrHangingSignKeyboard _keyboard;
    private final boolean _isFront;

    public XrHangingSignEditScreen(Component title, HangingSignBlockEntity sign, boolean isFront) {
        super(title);
        _sign = sign;
        _isFront = isFront;
        ...
        _keyboard = new XrHangingSignKeyboard(this, _isFront);
